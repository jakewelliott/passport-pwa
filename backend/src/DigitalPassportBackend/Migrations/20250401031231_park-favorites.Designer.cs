            ...
            modelBuilder.Entity("DigitalPassportBackend.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            createdAt = new DateTime(2025, 4, 1, 3, 12, 31, 323, DateTimeKind.Utc).AddTicks(2060),
                            password = "10000./pUMPcgjbpUd/WEM02DF8A==.7tSgWm0JvxgqVUFyxCqUQXwEuBHnap2RJ1Qx8FNy2Pc=",
                            role = "admin",
                            updatedAt = new DateTime(2025, 4, 1, 3, 12, 31, 323, DateTimeKind.Utc).AddTicks(2050),
                            username = "superAdmin"
                        },
                        new
                        {
                            id = 2,
                            createdAt = new DateTime(2025, 4, 1, 3, 12, 31, 330, DateTimeKind.Utc).AddTicks(1100),
                            password = "10000.GiJwrDRtYPW51ZQuiDeVqQ==.xE5XWDsMX2+ugrSmFdVfk5ys4oSK5e1Mb45ibc5l7jk=",
                            role = "visitor",
                            updatedAt = new DateTime(2025, 4, 1, 3, 12, 31, 330, DateTimeKind.Utc).AddTicks(1100),
                            username = "testUser"
                        });
                });
