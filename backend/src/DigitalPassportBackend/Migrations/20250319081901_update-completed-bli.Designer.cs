            ...
            modelBuilder.Entity("DigitalPassportBackend.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            id = 1,
                            createdAt = new DateTime(2025, 3, 19, 8, 19, 1, 409, DateTimeKind.Utc).AddTicks(8540),
                            password = "10000.Wlwlf1u9GPy0RXqWjUh2Vw==.dt/BTOgUPv4cFixnQ8+YCiJUnUfd1ANW19bS6NgDGKw=",
                            role = "admin",
                            updatedAt = new DateTime(2025, 3, 19, 8, 19, 1, 409, DateTimeKind.Utc).AddTicks(8530),
                            username = "superAdmin"
                        },
                        new
                        {
                            id = 2,
                            createdAt = new DateTime(2025, 3, 19, 8, 19, 1, 416, DateTimeKind.Utc).AddTicks(5500),
                            password = "10000.hWIO5GUqAl7PzmsyOyiT3A==.Fmz3RxgQC+59pJzdwbnCMyp+3/Y+Ab2RPawHGsyZ/UE=",
                            role = "visitor",
                            updatedAt = new DateTime(2025, 3, 19, 8, 19, 1, 416, DateTimeKind.Utc).AddTicks(5500),
                            username = "testUser"
                        });
                });
