...
/*!40101 SET character_set_client = utf8 */
;
CREATE TABLE IF NOT EXISTS `stamp_collection_method_enum` (`value` enum('manual', 'location') NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
/*!40101 SET character_set_client = utf8 */
;
CREATE TABLE IF NOT EXISTS `states_enum` (`value` enum('NC') NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
...
/*!40101 SET character_set_client = utf8 */
;
CREATE TABLE IF NOT EXISTS `user_roles_enum` (`value` enum('visitor', 'admin') NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */
;
--
