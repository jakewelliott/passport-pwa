...
public class ParksService
{
    ...
    public ParksService(
        ...
        IParkAddressRepository parkAddressRepository,
        ...
        IBucketListItemRepository bucketListItemRepository)
    {
        ...
        _addressRepository = parkAddressRepository;
        ...
        List<ParkPhoto> photos)
    {
        ...
        Helpers.SetValues(_addressRepository.GetByLocationId(park.id), addrs, _addressRepository);
        Helpers.SetValues(_parkIconRepository.GetByLocationId(park.id), icons, _parkIconRepository);
        Helpers.SetValues(_bucketListItemRepository.GetByLocationId(park.id), blItems, _bucketListItemRepository);
        Helpers.SetValues(_parkPhotoRepository.GetByLocationId(park.id), photos, _parkPhotoRepository);
    }
    ...
    private class ParkGeometry(string ParkAbbreviation)
    {
