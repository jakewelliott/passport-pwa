    ...
    return (
      <div className='relative' ref={menuRef}>
        {isParkDetail && (
          ...
          className='flex items-center text-system_white p-2'
          type='button'
        ...
        {isOpen && (
          <div className='absolute right-0 top-full mt-2 w-48 rounded-md bg-system_white shadow-lg ring-1 ring-black ring-opacity-5'>
            <div className='py-1'>
              {isParkDetail && (
                <button
