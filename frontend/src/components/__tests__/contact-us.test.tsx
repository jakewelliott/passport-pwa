...
import { ContactUs } from '../tabs/more/contact-us';
...
describe('ContactUs', () => {
	it('renders the header correctly', () => {
		...
		expect(header.parentElement).toHaveClass('bg-supporting_inactiveblue', 'p-2', 'text-center', 'text-system_white');
	});
	...
	it('renders social media links with correct attributes', () => {
		...
		const socialMediaLinks = links.filter(link => Object.values(socialLinks).includes(link.getAttribute('href') || ''));
