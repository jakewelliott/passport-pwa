...
import { TrailMap } from '../tabs/more/trail-map';
...
describe('TrailMap', () => {
	...
	it('splits trail names into two columns', () => {
		...
		const firstColumnTrails = ['Dan River', 'Deep River', 'East Coast Greenway', 'Equine',
			'Fonta Flora', 'French Broad River', 'Haw River'];
		const secondColumnTrails = ['Hickory Nut Gorge', 'Mountains-to-Sea', 'Northern Peaks',
			'Overmountain Victory', 'Roanoke River', 'Wilderness Gateway', 'Yadkin River'];
