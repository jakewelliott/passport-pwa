    ...
    return (
        <div className='flex flex-col mt-6 mb-6'>
            <p className="pl-6 pr-6">
                {park.established && <><span className="green-text">Established: </span>{park.established}<br /><br /></>}
                {park.landmark && <><span className="green-text">Landmark: </span>{park.landmark}<br /><br /></>}
                {park.youCanFind && <><span className="green-text">You can find... </span>{park.youCanFind}<br /><br /></>}
                {park.trails && <><span className="green-text">Trails: </span>{park.trails}<br /><br /></>}
            </p>
            <div className="icon-scroll-container overflow-x-auto">
                <div className="inline-flex gap-6 px-6">
                    ...
                    <div className="w-px flex-shrink-0"></div>
                </div>
            </div>
