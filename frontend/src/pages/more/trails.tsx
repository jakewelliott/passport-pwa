...
export const Trails = () => {
    ...
    const trailDetails: TrailDetails[] = [
        ...
        },
        {
            ...
            trailIcons: [],
            distance: "795 miles",
            description: "V-shaped: one arm through Raleigh, Durham and the Triangle and other arm through Albemarle and Pamlico Sounds, both meeting at Wilmington"
        },
        {
    ...
    return (
        <div className="m-6">
            ...
            <p className="text-center">
                ...
                <a href="https://trails.nc.gov/state-trails" className="text-main_blue">trails.nc.gov/state-trails</a>
            </p>
            <TrailMap />
        </div>
    );
