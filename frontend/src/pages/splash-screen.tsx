const SplashScreen = () => {
  return (
    <div className="fixed inset-0 flex flex-col items-center bg-no-repeat" style={{
      ...
      <img src="./DPRLogoWhite.svg" alt="North Carolina Department of Parks and Rec White Logo" width="136" height="103" />
      <h3>North Carolina State Parks</h3>
      <p className='script' style={{paddingTop: 30}}>Passport</p>
      </div>
    </div>
  );
};
