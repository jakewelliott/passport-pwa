...
const WelcomeMessage: React.FC = () => {
  ...
  const photos = [
    ...
    { photoPath: '/photos/MOJESign_ParkVisitor_EverettFamily.jpg', alt: 'Mount Jefferson State Natural Area Scene' },
    ...
    <>
      <div className='mx-auto max-w-3xl space-y-6 p-6'>
        ...
        <div className='space-y-4'>
          <p>
            Since 1916, North Carolina's state parks have grown a lot. Now they cover over a 260,000 acres and offer
            tons of things to do and see. There's something for everyone!
          </p>
          ...
          <p>
            ...
            amazing places that show how we fit into the natural world. There are also exhibits and programs to learn
            more about North Carolina's wonders.
          </p>

          <p>
            We challenge you to visit as many of these amazing places as you can. Come join us to explore and learn
            about North Carolina's awesome natural and cultural treasures. We hope this program inspires you to create
