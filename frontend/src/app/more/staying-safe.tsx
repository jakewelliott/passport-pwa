export default function StayingSafe() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h4 className="text-center text-system_white mb-6 w-full p-3 bg-supporting_inactiveblue uppercase">
        How to Stay Safe While Visiting NC State Parks
      </h4>
      
      <p className="mb-6">
        To keep everyone safe and protect our parks, please follow these rules and safety
        guidelines while you're here!
      </p>
