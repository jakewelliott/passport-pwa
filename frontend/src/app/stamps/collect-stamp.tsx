...
export default function CollectStamp() {
    ...
    return (
        <div className='fixed inset-0 flex items-center justify-center bg-secondary-lightblue' style={{ zIndex: 9999 }}>
            <div className='m-auto flex max-w-3xl flex-col items-center gap-8 p-2 text-center'>
                <span
                    className='absolute top-4 right-6 z-10 cursor-pointer font-bold text-h1 text-supporting-darkgray'
                    {...a11yOnClick(close)}
                >
                    &times;
                </span>
                <h1 className='text-secondary-darkteal uppercase'>Woohoo!</h1>
                <p>
