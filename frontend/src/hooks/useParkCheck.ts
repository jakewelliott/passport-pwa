...
const bounds = (geoJSONData as GeoJSON.FeatureCollection)
...
const parkCheck = (
	...
	const containingFeature = bounds.find((feature) =>
	...
	return parks.find((park) =>
		park.name.startsWith(containingFeature.properties?.PK_NAME),
	);
};
